      ...
      <tbody>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr class="header">
                <td align="left" valign="top">
                  <img src="{{asset('email-template')}}/images/logo.png" class="main-logo" />
                </td>
        ...
        <tr>
          <td class="banner">
            <table>
              <tr>
                <td colspan="2"><img style="width: 100%" src="{{asset('email-template')}}/images/banner5.jpg" alt="banner" /></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td class="section-t" style="position: relative; padding: 0 calc(15px + (88 - 15) * ((100vw - 320px) / (1920 - 320)))">
            <table style="width: 100%">
              <tr>
                <td>
                  <h1 class="heading-1" style="margin-bottom: 6px">Hi Jonny And Welcome To Multikart.!</h1>
                  <p class="pera">
        ...
        <tr>
          <td class="section-t" style="padding: 0 calc(15px + (46 - 15) * ((100vw - 320px) / (1920 - 320)))">
            <p class="pera">
              If you have any question, please email us at <a href="javascript:void(0)">Multikart@example.com </a> or visit our <a href="javascript:void(0)"> FAQs.</a> You can also chat with a real
              ...
              <tr>
                <td class="footer-content">
                  <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center" class="text-center" style="vertical-align: middle; margin: 0 auto; width: 326px">
                    <tr class="social">
                      <td>
                        <a href="javascript:void(0)"><img src="{{asset('email-template')}}/images/fb.png" alt="fb" /></a>
                      </td>
                      <td>
                        <a href="javascript:void(0)"><img src="{{asset('email-template')}}/images/insta.png" alt="insta" /></a>
                      </td>
                      <td>
                        <a href="javascript:void(0)"><img src="{{asset('email-template')}}/images/twitter-w.png" alt="twitter" /></a>
                      </td>
                      <td>
                        <a href="javascript:void(0)"><img src="{{asset('email-template')}}/images/pinterest-w.png" alt="pinterest" /></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <p>THIS EMAIL WAS CREATED USING THE multikart. MADE WITH BY DESIGN multikart TEAM.</p>
                        <a class="unsubscribe" href="javascript:void(0)"> UNSUBSCRIBE </a>
                      </td>
                    </tr>
                  </table>
                </td>
