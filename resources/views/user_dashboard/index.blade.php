                    ...
                    <div class="dashboard-sidebar">
                        <div class="profile-top">
                            <div class="profile-image">
                                <img src="{{asset('/')}}assets/images/avtar.jpg" alt="" class="img-fluid">
                            </div>
                                                ...
                                                <table class="table cart-table order-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/1.jpg"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/2.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/27.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/28.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/33.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('/')}}assets/images/pro3/34.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="address-book-section">
                                                <div class="row g-4">
                                                    <div class="select-box active col-xl-4 col-md-6">
                                                        <div class="address-box">
                                                            <div class="bank-logo">
                                                                <img src="{{asset('/')}}assets/images/bank-logo.png"
                                                                    class="bank-logo">
                                                    ...
                                                    <div class="select-box col-xl-4 col-md-6">
                                                        <div class="address-box">
                                                            <div class="bank-logo">
                                                                <img src="{{asset('/')}}assets/images/bank-logo1.png"
                                                                    class="bank-logo">
                                                                <img src="{{asset('/')}}assets/images/visa.png"
                                                                    class="network-logo">
                                                            </div>
